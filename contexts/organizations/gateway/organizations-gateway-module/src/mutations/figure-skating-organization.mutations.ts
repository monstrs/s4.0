import type * as rpc                               from '@organizations/client-module'
...
import { Timestamp }                               from '@organizations/client-module'
...
export class FigureSkatingOrganizationMutations {
  constructor(private readonly client: OrganizationsClient) {}
