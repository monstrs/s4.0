...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    createFigureSkatingOrganization(variables: CreateFigureSkatingOrganizationMutationVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CreateFigureSkatingOrganizationMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<CreateFigureSkatingOrganizationMutation>(CreateFigureSkatingOrganizationDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'createFigureSkatingOrganization', 'mutation', variables);
    },
    loadFigureSkatingOrganizations(variables?: LoadFigureSkatingOrganizationsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<LoadFigureSkatingOrganizationsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<LoadFigureSkatingOrganizationsQuery>(LoadFigureSkatingOrganizationsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'loadFigureSkatingOrganizations', 'query', variables);
    }
  };
}
