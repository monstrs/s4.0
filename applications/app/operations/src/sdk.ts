...
export type CreateFigureSkatingOrganizationInput = {
  ...
  curatorId: Scalars['String']['input'];
  disciplines: Array<FigureSkatingDisciplines>;
  foundingDate: Scalars['DateTime']['input'];
